...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{route('tasksPrint')}}" target="_blank" class="btn btn-secondary btn-sm float-right m-l-10"><i class="fa fa-print"></i></a>
            <a href="{{route('tasksReport')}}" class="btn btn-success btn-sm float-right">Excel</a>
        </div>
        <div class="card-body">
            @if($tasks->count() > 0)
                <table class="table">
